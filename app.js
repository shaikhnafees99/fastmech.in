...
const translations = {
  en: {
    ...
    heroTitle: "Fast Mechanic for jump start, key lock, towing, petrol delivery, stepney change and car mechanic help.",
    heroLede: "Stuck at home, office, highway, parking basement or late-night road? Call Fast Mechanic for urgent car breakdown support across Mumbai, Andheri and Thane.",
    callNow: "Call Now",
    ...
    localSeoText: "Fast Mechanic supports high-intent roadside assistance searches across South Mumbai, central Mumbai, Bandra-Andheri corridor and Thane.",
    ...
    faqAnswers: [
      ...
      "Yes. If your car cannot be moved safely, Fast Mechanic can help arrange towing support in Mumbai, Andheri and Thane.",
  ...
  whatsapp: "WhatsApp चैट",
    ...
    heroTitle: "जंप स्टार्ट, की लॉक, टोइंग, पेट्रोल डिलिव्हरी, स्टेपनी बदल आणि कार मेकॅनिक मदतीसाठी Fast Mechanic.",
    ...
    localSeoText: "Fast Mechanic South Mumbai, central Mumbai, Bandra-Andheri corridor आणि Thane साठी high-intent roadside assistance searches ला support करते.",
...
translations.hi = {
  ...
  heroTitle: "जंप स्टार्ट, की लॉक, टोइंग, पेट्रोल डिलीवरी, स्टेपनी बदलने और कार मैकेनिक मदद के लिए Fast Mechanic.",
  heroLede: "घर, ऑफिस, हाईवे, पार्किंग बेसमेंट या देर रात सड़क पर फंसे हैं? मुंबई, अंधेरी और ठाणे में तुरंत कार ब्रेकडाउन सहायता के लिए कॉल करें.",
...
translations.ur = {
  ...
  heroTitle: "جمپ اسٹارٹ، کی لاک، ٹوئنگ، پیٹرول ڈیلیوری، اسٹیپنی تبدیلی اور کار مکینک مدد کے لیے Fast Mechanic.",
  heroLede: "گھر، دفتر، ہائی وے، پارکنگ بیسمنٹ یا رات میں سڑک پر پھنس گئے؟ ممبئی، اندھیری اور تھانے میں فوری مدد کے لیے کال کریں.",
...
translations.gu = {
  ...
  heroTitle: "જમ્પ સ્ટાર્ટ, કી લોક, ટોઇંગ, પેટ્રોલ ડિલિવરી, સ્ટેપની બદલાવ અને કાર મેકેનિક મદદ માટે Fast Mechanic.",
  heroLede: "ઘર, ઓફિસ, હાઇવે, પાર્કિંગ બેઝમેન્ટ અથવા રાત્રે રસ્તા પર ફસાયા છો? મુંબઈ, અંધેરી અને થાણેમાં તાત્કાલિક મદદ માટે કોલ કરો.",
...
translations.ta = {
  ...
  heroTitle: "ஜம்ப் ஸ்டார்ட், கீ லாக், டோயிங், பெட்ரோல் டெலிவரி, ஸ்டெப்னி மாற்றம் மற்றும் கார் மெக்கானிக் உதவிக்கு Fast Mechanic.",
  heroLede: "வீடு, அலுவலகம், ஹைவே, பார்க்கிங் பேஸ்மென்ட் அல்லது இரவு சாலையில் சிக்கியுள்ளீர்களா? மும்பை, அந்தேரி மற்றும் தானே பகுதியில் உடனடி உதவிக்கு அழைக்கவும்.",
...
Object.assign(translations.hi, {
  ...
  metrics: ["घंटे सहायता", "मुंबई जोन", "इमरजेंसी सेवाएं", "सीधा कॉल नंबर"],
  ...
  serviceBadges: ["जंप स्टार्ट", "की लॉक", "टोइंग", "फ्यूल हेल्प", "स्टेपनी", "मैकेनिक"],
  serviceTexts: [
  ...
  coverageText: "Fast Mechanic residential towers, office zones, highways, station areas, mall parking, airport routes और South Mumbai business districts में कार ब्रेकडाउन सहायता देता है.",
  ...
  localSeoText: "Fast Mechanic South Mumbai, central Mumbai, Bandra-Andheri corridor और Thane में high-intent roadside assistance searches को support करता है.",
  ...
  seoText: "इस वेबसाइट में local business schema, service catalog schema, FAQ schema, canonical URL, sitemap, robots file और downloadable vCard शामिल है.",
  ...
  faqEyebrow: "FAQ",
  faqTitle: "तुरंत कार ब्रेकडाउन searches के जवाब.",
  ...
  faqAnswers: [`हां. मुंबई में dead battery और car jump start के लिए Fast Mechanic को ${PHONE_DISPLAY} पर कॉल करें.`, "Fast Mechanic car lockout और key lock स्थिति में मदद कर सकता है. कार मॉडल और लोकेशन बताकर कॉल करें.", "हां. अगर कार सुरक्षित नहीं चल सकती, तो Fast Mechanic मुंबई, अंधेरी और ठाणे में towing support arrange कर सकता है.", `हां. Save Contact button से Fast Mechanic, ${PHONE_DISPLAY}, को सीधे contacts में सेव करें.`],
  footerSmall: "मुंबई इमरजेंसी कार सहायता",
  footerText: "बैटरी जंप स्टार्ट, key lockout, towing, petrol delivery, stepney change और car mechanic service के लिए 24/7 roadside assistance.",
  footerServices: ["बैटरी जंप स्टार्ट", "टोइंग सेवा", "पेट्रोल डिलीवरी", "स्टेपनी बदलना"],
...
Object.assign(translations.ur, {
  metrics: ["گھنٹے مدد", "ممبئی زونز", "ایمرجنسی سروسز", "براہ راست کال نمبر"],
  ...
  serviceBadges: ["جمپ اسٹارٹ", "کی لاک", "ٹوئنگ", "فیول مدد", "اسٹیپنی", "مکینک"],
  serviceTexts: [
  ...
  emergencyText: "Fast Mechanic ممبئی بھر میں high-intent emergency car services میں مدد دیتا ہے.",
  ...
  coverageText: "Fast Mechanic residential towers، office zones، highways، station areas، mall parking، airport routes اور South Mumbai business districts میں car breakdown support دیتا ہے.",
  ...
  localSeoText: "Fast Mechanic South Mumbai، central Mumbai، Bandra-Andheri corridor اور Thane میں high-intent roadside assistance searches support کرتا ہے.",
  localSeoCta: "ابھی کال کریں",
  seoEyebrow: "سرچ ریڈی کانٹیکٹ",
  seoTitle: "search engines اور customers کے لیے Fast Mechanic service card details.",
  seoText: "اس website میں local business schema، service catalog schema، FAQ schema، canonical URLs، sitemap، robots file اور downloadable vCard شامل ہے.",
  ...
  faqEyebrow: "FAQ",
  faqTitle: "urgent car breakdown searches کے جواب.",
...
Object.assign(translations.gu, {
  ...
  metrics: ["કલાક સહાય", "મુંબઈ ઝોન", "ઇમરજન્સી સેવાઓ", "સીધો કોલ નંબર"],
  ...
  serviceBadges: ["જમ્પ સ્ટાર્ટ", "કી લોક", "ટોઇંગ", "ફ્યુઅલ મદદ", "સ્ટેપની", "મેકેનિક"],
  serviceTexts: [
  ...
  emergencyText: "Fast Mechanic મુંબઈભરમાં high-intent emergency car services માટે મદદ આપે છે.",
  ...
  coverageText: "Fast Mechanic residential towers, office zones, highways, station areas, mall parking, airport routes અને South Mumbai business districts માટે car breakdown support આપે છે.",
  ...
  localSeoText: "Fast Mechanic South Mumbai, central Mumbai, Bandra-Andheri corridor અને Thane માં high-intent roadside assistance searches support કરે છે.",
  localSeoCta: "હમણાં કોલ કરો",
  seoEyebrow: "સર્ચ રેડી કૉન્ટેક્ટ",
  seoTitle: "search engines અને customers માટે Fast Mechanic service card details.",
  seoText: "આ website માં local business schema, service catalog schema, FAQ schema, canonical URLs, sitemap, robots file અને downloadable vCard છે.",
  ...
  faqEyebrow: "FAQ",
  faqTitle: "urgent car breakdown searches માટે જવાબો.",
...
Object.assign(translations.ta, {
  ...
  metrics: ["மணி நேர உதவி", "மும்பை மண்டலங்கள்", "அவசர சேவைகள்", "நேரடி அழைப்பு எண்"],
  ...
  serviceBadges: ["ஜம்ப் ஸ்டார்ட்", "கீ லாக்", "டோயிங்", "எரிபொருள் உதவி", "ஸ்டெப்னி", "மெக்கானிக்"],
  serviceTexts: [
  ...
  emergencyText: "Fast Mechanic மும்பை முழுவதும் high-intent emergency car services க்கு உதவுகிறது.",
  ...
  coverageText: "Fast Mechanic residential towers, office zones, highways, station areas, mall parking, airport routes மற்றும் South Mumbai business districts இல் car breakdown support வழங்குகிறது.",
  ...
  localSeoText: "Fast Mechanic South Mumbai, central Mumbai, Bandra-Andheri corridor மற்றும் Thane இல் high-intent roadside assistance searches support செய்கிறது.",
  localSeoCta: "இப்போது அழைக்கவும்",
  seoEyebrow: "Search Ready Contact",
  seoTitle: "search engines மற்றும் customers க்கான Fast Mechanic service card details.",
  ...
  faqEyebrow: "FAQ",
  faqTitle: "urgent car breakdown searches க்கான பதில்கள்.",
